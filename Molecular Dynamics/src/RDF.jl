...
export rdf, initialize!, compute!, finalize!

function initialize!(calc::rdf, system_::systemtype) where systemtype
...
function compute!(calc::rdf, system::systemtype) where systemtype
    r = positions(system)
