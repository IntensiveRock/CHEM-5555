...
export msd, initialize!, compute!, finalize!

function initialize!(calc::msd, system_::systemtype) where systemtype
    r = positions(system_)
...
function compute!(calc::msd, system::systemtype) where systemtype
    r = positions(system)
